...
import { GiScrollUnfurled, GiSpellBook, GiZeusSword, GiSwordsEmblem, GiMagicAxe, GiDwarfFace } from 'react-icons/gi';
import libImg from '/src/assets/lib.png';

export default function IconGrid() {
    return (
        <div className="even-section" style={{ backgroundImage: `url(${libImg})`, backgroundSize: 'cover', backgroundPosition: 'center', color: 'white', padding: '50px 0' }}>
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-1 col-md-12 d-flex align-items-center justify-content-center">
