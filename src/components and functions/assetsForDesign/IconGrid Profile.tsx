...
export default function IconGridProfile() {
    ...
    return (
        <div className="even-section" style={{ backgroundImage: `url(${profImg})`, backgroundColor: "black", backgroundSize: 'cover', backgroundPosition: 'center', color: 'white', padding: '50px 0' }}>
            <div className="container">
                <div className="row">
                    <div className="col-lg-12 col-md-12 mb-4">
                        <h2 className="p-3 text-center">As a {user[0].isMaster ? "Master" : "player"} here are your choices:</h2>
                        <div className="row justify-content-center">
                            {user[0].isMaster && <div className="col-lg-2 col-md-4 col-sm-6 mb-4">
