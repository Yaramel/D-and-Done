...
import { CharListItem, ClassListItem, RaceListItem, RuleListItem, SpellListItem } from "../assetsForDesign/ListItems";
...
export default function CampaignInfoboard({ campaignData }: CampaignInfoboardProps) {
    const themeImageUrl = `/src/assets/themes/${campaignData.theme.toLowerCase()}.png`;
                            ...
                            <div className="row">
                                ...
                                <section className="container m-3 campaignDetails">
                                    ...
                                    <div className="row">
                                        ...
                                        {campaignData.homebrews.rules.length > 0 && <div className="col-md-12">
                                        ...
                                        {campaignData.homebrews.spells.length > 0 && <div className="col-md-12">
                                        ...
                                        {campaignData.ban.classes.length > 0 && <div className="col-md-12">
                                        ...
                                        {campaignData.ban.races.length > 0 && <div className="col-md-12">
                                        ...
                                        {campaignData.ban.spells.length > 0 && <div className="col-md-12">
                                        ...
                                        <div className="col-md-12">
                                            <hr className="my-5 separator" style={{ borderWidth: "3px" }} />
                                            <strong>Characters  <span>({campaignData.characters.length} /{campaignData.playersNum})</span> </strong>
                                            <div className="row">
