                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-3 d-flex align-items-center">
                            ...
                            <a href={itemInfo ? `/equipment/${itemInfo.index.replaceAll("/", "")}` : "#"} className="custom-link">  {itemInfo && itemInfo.name ? itemInfo.name : "-"} </a>


                        </div>
                        <div className="col-md-3 d-flex align-items-center">
                            {itemInfo && itemInfo.armor_category ? (itemInfo.armor_category == "Shield" ? "+2" : "" + (itemInfo.armor_class ? itemInfo.armor_class.base : "-")) : (itemInfo.damage ? itemInfo.damage.damage_dice + " " + itemInfo.damage.damage_type.name : "")}

                        </div>
                        <div className="col-md-3 d-flex align-items-center">
                            {isEquiped == true ? "Equiped" : (isEquiped == false ? "Not Equiped" : "")}


                        </div>
                        <div className="col-md-2 d-flex align-items-center">
                            <a href={itemInfo ? `/equipment/${itemInfo.index.replaceAll("/", "")}` : "#"} className="btn btn-outline-info">More Info</a>
                        </div>
            ...
            <div className="rounded equipmentBoard p-2 my-1" >
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-3 d-flex align-items-center ">
                            <a href={itemInfo?.index ? `/spells/${itemInfo.index.replaceAll("/", "")}` : "#"} className="custom-link">   {itemInfo && itemInfo.name} </a>
                        ...
                        {showDescription && (
                            <div>
                                ...
                                <a href={itemInfo ? `/spells/${itemInfo.index.replaceAll("/", "")}` : "#"} className="btn btn-outline-info">More Info</a>
